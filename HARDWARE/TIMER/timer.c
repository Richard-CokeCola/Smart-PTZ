...
{  
   ...
   //设置该引脚为复用输出功能,输出TIM3 CH2的PWM脉冲波形	GPIOB.5
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5; //TIM_CH2              ！！！！！！！！！！！！！pwm引脚定义！
   ...
   //初始化TIM3
	...
	TIM_SetCompare3(TIM2,2500);		 // 占空比     旋转舵机    关联yaw  
...
{  
   ...
   //设置该引脚为复用输出功能,输出TIM3 CH2的PWM脉冲波形	GPIOB.5
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3; //TIM_CH2              ！！！！！！！！！！！！！pwm引脚定义！
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;  //复用推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOB, &GPIO_InitStructure);//初始化GPIO
   ...
   //初始化TIM3
	...
	TIM_SetCompare2(TIM2,2500);		 // 占空比     旋转舵机    关联yaw  
